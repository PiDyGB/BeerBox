...
import com.giuseppebuzzanca.beerbox.data.source.BeersRepository
import com.giuseppebuzzanca.beerbox.util.BeerType
import com.giuseppebuzzanca.beerbox.util.asUIModel
...
class BeersViewModel @Inject constructor(private val beersRepository: BeersRepository) : ViewModel() {
    ...
    fun getBeers(visibleItemCount: Int?, firstVisibleItemPosition: Int?, totalItemCount: Int?) {
        if (visibleItemCount?.plus(firstVisibleItemPosition ?: 0) ?: 0 >= (totalItemCount ?: 0) - 10
            ...
            && totalItemCount ?: 0 >= BeersViewModel.ITEM_PER_PAGE
        ) {
